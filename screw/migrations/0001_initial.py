# Generated by Django 4.0 on 2021-12-24 22:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255, verbose_name='Название Основной Категории')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='screw.categories', verbose_name='Основная Категория')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='screw.subcategory', verbose_name='ПодКатегория Продукта')),
            ],
            options={
                'verbose_name_plural': 'Тип продука Продукта ПодКатегории',
            },
        ),
        migrations.CreateModel(
            name='ProductRange',
        ...
        migrations.AddField(
            model_name='product',
            name='sub_category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='screw.subcategory', verbose_name='ПодКатегория товара'),
        ),
    ]
